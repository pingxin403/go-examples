// hello.proto — gRPC HelloService 定义
//
// 本文件定义了一个简单的问候服务，包含基本的 RPC 调用。
//
// 生成 Go 代码:
//   cd 07-web/grpc
...
const file_proto_hello_proto_rawDesc = "" +
	...
	"\x0eSayHelloStream\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponse0\x01B5Z3github.com/pingxin403/go-examples/07-web/grpc/protob\x06proto3"
